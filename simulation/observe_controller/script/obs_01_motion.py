...
class PublishThread(threading.Thread):
    def __init__(self, rate):
        ...
        self.publisher = rospy.Publisher('/obs_01/cmd_vel', Twist, queue_size=1)
        self.x = 0.0
        self.y = 0.0
        self.z = 0.0
        self.th = 0.0
...
class DroneController:
    def __init__(self):
        # 目标点
        self.point_1 = [-1.0, -16.2] # start
        self.point_2 = [-0.5, -14.5] # back
        ...
        # ROS 话题订阅与发布
        self.cmd_vel_pub = rospy.Publisher('/obs_01/cmd_vel', Twist, queue_size=1)
        self.pose_sub = rospy.Subscriber('/obs_01/ground_truth_to_tf/pose', PoseStamped, self.callback, queue_size=10)
    ...
    def callback(self, msg):
        ...
        ## rise
        if self.current_position[2] < 8.0:
            vel_msg = Twist()
            vel_msg.linear.x = 0
            vel_msg.linear.y = 0
