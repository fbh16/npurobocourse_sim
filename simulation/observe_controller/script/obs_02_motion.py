...
class DroneController:
    def __init__(self):
        # 目标点
        self.point_1 = [7.0, -16.2] # start
        self.point_2 = [6.5, -15.5] # back
...
if __name__ == '__main__':
    ...
    rospy.init_node('drone_motion_2')
    ...
    # rospy.Subscriber('/vrpn_client_node/obs_02/pose', PoseStamped, callback, queue_size=10)
