...
if __name__ == '__main__':
    ...
    # settings = termios.tcgetattr(sys.stdin)
    rospy.init_node('target_motion_02')
    ...
    altitude = 5.5   
    ax = [4.500, 3.526, 2.551, 1.577, 0.603, -0.371, -1.346, -2.320]
    ay = [-10.000, -7.960, -5.920, -3.880, -1.840, 0.200, 2.240, 4.280]
    ...
    rospy.Subscriber(f'/target_02/ground_truth_to_tf/pose', PoseStamped, callback, queue_size=10)
